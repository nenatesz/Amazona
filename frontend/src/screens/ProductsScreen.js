...
import { listProducts, saveProduct, deleteProduct } from "../actions/productsActions";
...
function ProductsSCreen(props) {
  ...
  useEffect(() => {
    ...
    // this is an array of variables that changing them re-runs the use effect
  ...
  return <div className='content content-margined'>
      <div className='product-header'>
          <h3>Products</h3>
          <button className="button primary" onClick={() => openModal({})}>Create Products</button>
      </div>
      {
